...
extension Color {
    ...
    static let background = LinearGradient(gradient: Gradient(colors: /*for array of color */ [Color("Background 1"), Color("Background 2")]), startPoint: .topLeading, endPoint: .bottomTrailing)
...
class Colors{
    ...
    let grayTextColor = Color("gray_text_color")
    let greenDark = Color("green_dark")
    let logoGreen = Color("logo_green")
    let logoPink = Color("logo_pink")
